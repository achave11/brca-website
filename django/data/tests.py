...
from data.views import index, autocomplete, index_num_2, brca_to_ga4gh, ErrorMessages, get_offset, get_var_by_id, get_variantSet
...
############################# NEW TESTS START #####################################
    ...
    def test_variantSets_fields(self):
        ...
        self.assertEqual(Comp["referenceSetId"], "Genomic_Coordinate_hg37")
        self.assertEqual(Comp["datasetId"], "brca_exchange")
        self.assertEqual(Comp["name"], "brca_exchange_hg37")
